				...
				<div className='invite-modal-content'>
					...
					<div className='invite-modal-header'>
						...
						<p className='invite-modal-subtitle'>
							{roomName || "Share this room with others"}
						</p>
					</div>
						...
						<>
							...
							<div className='glass-card mb-4'>
								...
								<p className='text-white mb-3'>
									Share this code with participants to join the room
								</p>
								...
								<div className='invite-code-display'>
									...
									>
										<i
											className={`fas ${copied ? "fa-check" : "fa-copy"} me-2`}
										></i>
										{copied ? "Copied!" : "Copy"}
									</button>
								</div>
							...
							<div className='glass-card'>
								...
								<p className='text-white mb-3'>
									Invite people directly via email
								</p>
							...
							<div className='quick-share-section mt-4'>
								...
								<div className='share-buttons'>
									<button
										...
										onClick={() =>
											window.open(
												`https://wa.me/?text=Join my Secret Santa room! Use code: ${inviteCode} or visit: ${inviteLink}`,
												"_blank"
											)
										}
									>
										...
										onClick={() =>
											window.open(
												`https://t.me/share/url?url=${encodeURIComponent(
													inviteLink
												)}&text=Join my Secret Santa room!`,
												"_blank"
											)
										}
									>
