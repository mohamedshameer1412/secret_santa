...
const CreateRoomModal = ({ isOpen, onClose, onRoomCreated }) => {
	...
	return (
		<>
			{/* Backdrop */}
			<div
				className='create-room-backdrop'
				onClick={handleClose}
			></div>
			...
			<div className='create-room-container'>
				<div className='create-room-content'>
					...
					<div className='progress-indicator'>
						...
						<div
							className={`progress-line ${step > 2 ? "completed" : ""}`}
						></div>
										...
										<div className='theme-selector'>
											<label
												className={`theme-option ${
													formData.theme === "christmas" ? "selected" : ""
												}`}
											>
												<input
													type='radio'
											...
											<label
												className={`theme-option ${
													formData.theme === "winter" ? "selected" : ""
												}`}
											>
												<input
													type='radio'
											...
											<label
												className={`theme-option ${
													formData.theme === "festive" ? "selected" : ""
												}`}
											>
												<input
													type='radio'
											...
											<label
												className={`theme-option ${
													formData.theme === "elegant" ? "selected" : ""
												}`}
											>
												<input
													type='radio'
								...
								<div className='glass-card'>
									...
									<div className='form-check form-switch mb-3'>
										...
										>
											...
											<p className='mb-0 text-muted small'>
												Invite only (participants need invite code)
											</p>
										</label>
									</div>
									...
									<div className='form-check form-switch mb-3'>
										...
										>
											...
											<p className='mb-0 text-muted small'>
												Let participants create wish lists
											</p>
										</label>
									</div>
								...
								<div className='glass-card'>
									...
									<div className='review-features'>
										...
										<div className='feature-tags'>
											...
											{formData.allowWishlist && (
												<span className='feature-tag'>
													<i className='fas fa-list me-1'></i>Wishlists
												</span>
											)}
											{formData.allowChat && (
												<span className='feature-tag'>
